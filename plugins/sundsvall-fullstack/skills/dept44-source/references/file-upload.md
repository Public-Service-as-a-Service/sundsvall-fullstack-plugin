...
Real examples:
- `~/code/scit/api-service-support-management/.../ErrandAttachmentsResource.java`
- `~/code/scit/api-service-document/.../DocumentResource.java`
- `~/code/scit/api-service-case-data/.../Base64MultipartFile.java`
- `~/code/scit/api-service-support-management/.../BlobMultipartFile.java`
