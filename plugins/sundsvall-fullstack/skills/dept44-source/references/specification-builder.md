...
- `~/code/scit/api-service-checklist/.../specification/SpecificationBuilder.java` (simple)
- `~/code/scit/api-service-support-management/.../util/SpecificationBuilder.java` (advanced)
